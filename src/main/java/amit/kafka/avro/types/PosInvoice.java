...
public class PosInvoice extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  ...
  @Deprecated public amit.kafka.avro.types.DeliveryAddress DeliveryAddress;
  @Deprecated public java.util.List<amit.kafka.avro.types.LineItem> InvoiceLineItem;
   ...
   * @param InvoiceLineItem The new value for InvoiceLineItem
   */
  public PosInvoice(java.lang.CharSequence InvoiceNumber, java.lang.Long CreatedTime, java.lang.CharSequence CustomerCardNo, java.lang.Double TotalAmount, java.lang.Integer NumberOfItems, java.lang.CharSequence PaymentMethod, java.lang.Double TaxableAmount, java.lang.Double CGST, java.lang.Double SGST, java.lang.Double CESS, java.lang.CharSequence StoreID, java.lang.CharSequence PosID, java.lang.CharSequence CashierID, java.lang.CharSequence CustomerType, java.lang.CharSequence DeliveryType, amit.kafka.avro.types.DeliveryAddress DeliveryAddress, java.util.List<amit.kafka.avro.types.LineItem> InvoiceLineItem) {
  ...
  public java.lang.Object get(int field$) {
    ...
    case 16: return InvoiceLineItem;
  ...
  public void put(int field$, java.lang.Object value$) {
    ...
    case 15: DeliveryAddress = (amit.kafka.avro.types.DeliveryAddress)value$; break;
    case 16: InvoiceLineItem = (java.util.List<amit.kafka.avro.types.LineItem>)value$; break;
    default: throw new org.apache.avro.AvroRuntimeException("Bad index");
    }
  }
   ...
   */
  public amit.kafka.avro.types.DeliveryAddress getDeliveryAddress() {
   ...
   * @param value the value to set.
   */
  public void setDeliveryAddress(amit.kafka.avro.types.DeliveryAddress value) {
    this.DeliveryAddress = value;
  }

  /**
   * Gets the value of the 'InvoiceLineItem' field.
   * @return The value of the 'InvoiceLineItem' field.
   */
  public java.util.List<amit.kafka.avro.types.LineItem> getInvoiceLineItem() {
    return InvoiceLineItem;
  }

  /**
   * Sets the value of the 'InvoiceLineItem' field.
   * @param value the value to set.
   */
  public void setInvoiceLineItem(java.util.List<amit.kafka.avro.types.LineItem> value) {
   ...
   */
  public static amit.kafka.avro.types.PosInvoice.Builder newBuilder() {
    return new amit.kafka.avro.types.PosInvoice.Builder();
  }
   ...
   * @return A new PosInvoice RecordBuilder
   */
  public static amit.kafka.avro.types.PosInvoice.Builder newBuilder(amit.kafka.avro.types.PosInvoice.Builder other) {
    return new amit.kafka.avro.types.PosInvoice.Builder(other);
  }
   ...
   * @return A new PosInvoice RecordBuilder
   */
  public static amit.kafka.avro.types.PosInvoice.Builder newBuilder(amit.kafka.avro.types.PosInvoice other) {
    return new amit.kafka.avro.types.PosInvoice.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<PosInvoice>
    ...
    private amit.kafka.avro.types.DeliveryAddress DeliveryAddress;
    private amit.kafka.avro.types.DeliveryAddress.Builder DeliveryAddressBuilder;
    private java.util.List<amit.kafka.avro.types.LineItem> InvoiceLineItem;
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(amit.kafka.avro.types.PosInvoice.Builder other) {
      super(other);
      ...
      if (other.hasDeliveryAddressBuilder()) {
        this.DeliveryAddressBuilder = amit.kafka.avro.types.DeliveryAddress.newBuilder(other.getDeliveryAddressBuilder());
      }
      if (isValidValue(fields()[16], other.InvoiceLineItem)) {
        this.InvoiceLineItem = data().deepCopy(fields()[16].schema(), other.InvoiceLineItem);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(amit.kafka.avro.types.PosInvoice other) {
            super(SCHEMA$);
      if (isValidValue(fields()[0], other.InvoiceNumber)) {
        this.InvoiceNumber = data().deepCopy(fields()[0].schema(), other.InvoiceNumber);
        fieldSetFlags()[0] = true;
    ...
    /**
      ...
      * @return This builder.
      */
    public amit.kafka.avro.types.PosInvoice.Builder setInvoiceNumber(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public amit.kafka.avro.types.PosInvoice.Builder clearInvoiceNumber() {
      InvoiceNumber = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public amit.kafka.avro.types.PosInvoice.Builder setCreatedTime(java.lang.Long value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public amit.kafka.avro.types.PosInvoice.Builder clearCreatedTime() {
      CreatedTime = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public amit.kafka.avro.types.PosInvoice.Builder setCustomerCardNo(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public amit.kafka.avro.types.PosInvoice.Builder clearCustomerCardNo() {
      CustomerCardNo = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public amit.kafka.avro.types.PosInvoice.Builder setTotalAmount(java.lang.Double value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public amit.kafka.avro.types.PosInvoice.Builder clearTotalAmount() {
      TotalAmount = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public amit.kafka.avro.types.PosInvoice.Builder setNumberOfItems(java.lang.Integer value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public amit.kafka.avro.types.PosInvoice.Builder clearNumberOfItems() {
      NumberOfItems = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public amit.kafka.avro.types.PosInvoice.Builder setPaymentMethod(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public amit.kafka.avro.types.PosInvoice.Builder clearPaymentMethod() {
      PaymentMethod = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public amit.kafka.avro.types.PosInvoice.Builder setTaxableAmount(java.lang.Double value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public amit.kafka.avro.types.PosInvoice.Builder clearTaxableAmount() {
      TaxableAmount = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public amit.kafka.avro.types.PosInvoice.Builder setCGST(java.lang.Double value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public amit.kafka.avro.types.PosInvoice.Builder clearCGST() {
      CGST = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public amit.kafka.avro.types.PosInvoice.Builder setSGST(java.lang.Double value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public amit.kafka.avro.types.PosInvoice.Builder clearSGST() {
      SGST = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public amit.kafka.avro.types.PosInvoice.Builder setCESS(java.lang.Double value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public amit.kafka.avro.types.PosInvoice.Builder clearCESS() {
      CESS = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public amit.kafka.avro.types.PosInvoice.Builder setStoreID(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public amit.kafka.avro.types.PosInvoice.Builder clearStoreID() {
      StoreID = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public amit.kafka.avro.types.PosInvoice.Builder setPosID(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public amit.kafka.avro.types.PosInvoice.Builder clearPosID() {
      PosID = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public amit.kafka.avro.types.PosInvoice.Builder setCashierID(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public amit.kafka.avro.types.PosInvoice.Builder clearCashierID() {
      CashierID = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public amit.kafka.avro.types.PosInvoice.Builder setCustomerType(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public amit.kafka.avro.types.PosInvoice.Builder clearCustomerType() {
      CustomerType = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public amit.kafka.avro.types.PosInvoice.Builder setDeliveryType(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public amit.kafka.avro.types.PosInvoice.Builder clearDeliveryType() {
      DeliveryType = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public amit.kafka.avro.types.PosInvoice.Builder setDeliveryAddress(amit.kafka.avro.types.DeliveryAddress value) {
     ...
     * @return This builder.
     */
    public amit.kafka.avro.types.DeliveryAddress.Builder getDeliveryAddressBuilder() {
      if (DeliveryAddressBuilder == null) {
        if (hasDeliveryAddress()) {
          setDeliveryAddressBuilder(amit.kafka.avro.types.DeliveryAddress.newBuilder(DeliveryAddress));
        } else {
          setDeliveryAddressBuilder(amit.kafka.avro.types.DeliveryAddress.newBuilder());
        }
      }
     ...
     * @return This builder.
     */
    public amit.kafka.avro.types.PosInvoice.Builder setDeliveryAddressBuilder(amit.kafka.avro.types.DeliveryAddress.Builder value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public amit.kafka.avro.types.PosInvoice.Builder clearDeliveryAddress() {
    ...
    /**
      * Sets the value of the 'InvoiceLineItem' field.
      * @param value The value of 'InvoiceLineItem'.
      * @return This builder.
      */
    public amit.kafka.avro.types.PosInvoice.Builder setInvoiceLineItem(java.util.List<amit.kafka.avro.types.LineItem> value) {
    ...
    /**
      * Checks whether the 'InvoiceLineItem' field has been set.
      * @return True if the 'InvoiceLineItem' field has been set, false otherwise.
      */
    public boolean hasInvoiceLineItem() {
      return fieldSetFlags()[16];
    }


    /**
      * Clears the value of the 'InvoiceLineItem' field.
      * @return This builder.
      */
    public amit.kafka.avro.types.PosInvoice.Builder clearInvoiceLineItem() {
    ...
    public PosInvoice build() {
      try {
        ...
        if (DeliveryAddressBuilder != null) {
          ...
          record.DeliveryAddress = fieldSetFlags()[15] ? this.DeliveryAddress : (amit.kafka.avro.types.DeliveryAddress) defaultValue(fields()[15]);
        }
        record.InvoiceLineItem = fieldSetFlags()[16] ? this.InvoiceLineItem : (java.util.List<amit.kafka.avro.types.LineItem>) defaultValue(fields()[16]);
        return record;
      } catch (Exception e) {
